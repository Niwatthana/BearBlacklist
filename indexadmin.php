...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/users.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Oct 2023 18:56:59 GMT -->
<head>
...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
  ...
  <header id="header" class="navbar navbar-expand-lg navbar-fixed navbar-height navbar-container navbar-bordered bg-white">
    <div class="navbar-nav-wrap">
      <!-- Logo -->
      <a class="navbar-brand" href="indexadmin.php" aria-label="Bearblacklist">
            ...
            <div class="card">
              ...
              <div class="card-body-height">
                ...
                <div class="dropdown-item bg-transparent text-wrap">
                  <a class="btn btn-soft-dark btn-xs rounded-pill" href="indexadmin.php">
                ...
                <a class="dropdown-item" href="indexadmin.php">
              ...
              <!-- Footer -->
              <a class="card-footer text-center" href="indexadmin.php">
          ...
          <li class="nav-item">
            ...
            <div class="dropdown">
              <a class="navbar-dropdown-account-wrapper" href="javascript:;" id="accountNavbarDropdown" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside" data-bs-dropdown-animation>
                <div class="avatar avatar-sm avatar-circle">
                  <img class="avatar-img" src="img/kew2435.jpg" alt="Image Description">
                ...
                <div class="dropdown-item-text">
                  <div class="d-flex align-items-center">
                    <div class="avatar avatar-sm avatar-circle">
                      ...
                      <img class="avatar-k" src="img/kew2435.jpg" alt="Image Description" >
                    </div>
                    <div class="flex-grow-1 ms-3">
                      <h5 class="mb-0">Niwatthana narabin</h5>
                      <p class="card-text text-body">0873961652za@gmail.com</p>
                    </div>
                  </div>
                </div>
  ...
  <aside class="js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered bg-white  ">
    <div class="navbar-vertical-container">
      <div class="navbar-vertical-footer-offset">
        ...
        <a class="navbar-brand" href="indexadmin.php" aria-label="Bearblacklist">
          <img class="navbar-brand-logo" src="img/icon.png" alt="Logo" data-hs-theme-appearance="default">
          <img class="navbar-brand-logo" src="img/icon.png" alt="Logo" data-hs-theme-appearance="dark">
          <img class="navbar-brand-logo-mini" src="img/icon.png" alt="Logo" data-hs-theme-appearance="default">
          <img class="navbar-brand-logo-mini" src="img/icon.png" alt="Logo" data-hs-theme-appearance="dark">
        </a>
          ...
          <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
            ...
            <div class="nav-item">
              ...
              <div id="navbarVerticalMenuDashboards" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenu">
                <a class="nav-link " href="search.php">Default</a>
            ...
            <div id="navbarVerticalMenuPagesMenu">
              ...
              <div class="nav-item">
                ...
                <div id="navbarVerticalMenuPagesUsersMenu" class="nav-collapse collapse show" data-bs-parent="#navbarVerticalMenuPagesMenu">
                  <a class="nav-link active" href="tableuser.php">listuser</a>
      ...
      <div class="page-header">
        <div class="row align-items-end">
          ...
          <div class="col-sm-auto">
            <a class="btn btn-primary" href="users-add-user.php">
              ...
              <tr>
                ...
                <td class="table-column-ps-0">
                  <a class="d-flex align-items-center" href="user-profile.html">
                    ...
                    <div class="ms-3">
                      <span class="d-block h5 text-inherit mb-0">Niwatthana narabin <i class="bi-patch-check-fill text-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Top endorsed"></i></span>
                      <span class="d-block fs-5 text-body">0873961652za@gmail.com</span>
                    </div>
                  </a>
                </td>
                <td>
      ...
      <header id="header" class="navbar navbar-expand-lg navbar-bordered bg-white  ">
        <div class="container">
          <nav class="js-mega-menu navbar-nav-wrap">
            ...
            <a class="navbar-brand" href="indexadmin.php" aria-label="Front">
              <img class="navbar-brand-logo" src="assets/svg/logos/logo.svg" alt="Logo" data-hs-theme-appearance="default">
              <img class="navbar-brand-logo" src="assets/svg/logos-light/logo.svg" alt="Logo" data-hs-theme-appearance="dark">
            </a>
              ...
              <ul class="navbar-nav">
                ...
                <li class="hs-has-sub-menu nav-item">
                  ...
                  <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="dashboardsMegaMenu" style="min-width: 14rem;">
                    <a class="dropdown-item active" href="indexadmin.php">Default</a>
                  ...
                  <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="pagesMegaMenu" style="min-width: 14rem;">
                    ...
                    <div class="hs-has-sub-menu nav-item">
                      ...
                      <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="usersMegaMenu" style="min-width: 14rem;">
                        <a class="dropdown-item " href="tableuser.php">listuser</a>
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/users.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Oct 2023 18:58:24 GMT -->
</html>