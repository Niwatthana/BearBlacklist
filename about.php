...
<body>
  ...
  <header class="bgimg w3-display-container w3-grayscale-min" id="home">
    <div class="w3-display-middle w3-center">
      <h1 class="txt-type" data-wait="5000" style="text-align: center; color: #fffdd0; text-shadow: 3px 3px #4d151574;
            font-size: 70px;" data-words='["อำนวยความสะดวกให้เพื่อเป็นการตัดสินใจ คิดให้ดีๆก่อนทำการโอนใดๆ วิเคราะห์เบอร์ที่ติดต่อว่ามาในแง่ใด ยับยั้งเบอร์มิจฉาชีพ"]'>
